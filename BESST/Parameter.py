...
class parameter(object):
    ...
    def __init__(self,parameter_mean_coverage = None, parameter_std_dev_coverage = None, parameter_mean_ins_size = None , parameter_std_dev_ins_size = None, 
                 ...
                 parameter_information_file = None, parameter_fosmidpool = None, parameter_extend_paths = None, parameter_development = None):
...
class counters(object):
    def __init__(self, param_count = None, param_non_unique = None, param_non_unique_for_scaf = None, param_nr_of_duplicates = None, param_prev_obs1 = None, param_prev_obs2 = None,
...
def MemoryUsage():
    ...
    stdout_list = percent_usage.communicate()[0] #.split('\n')
