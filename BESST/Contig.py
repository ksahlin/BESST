...
'''
class contig(object):
    __slots__ = ('name','scaffold','direction','position','length', 'coverage','repeat','is_haplotype','sequence')
    def __init__(self, contig_name,contig_scaffold= None ,contig_direction = None ,contig_position = None,
                  contig_length = None, contig_coverage=None, 
                  contig_repeat=False,contig_haplotype=False, contig_sequence = None): #, contig_links={}
